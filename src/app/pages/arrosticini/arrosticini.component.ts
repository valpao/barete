...
@Component({
  ...
  templateUrl: './arrosticini.component.html',
  styleUrl: './arrosticini.component.scss'
})
export class ArrosticiniComponent {
...
getCategories(): string[] {
  ...
  confirmOrder() {
    ...
    this.orders.confirm(this.cartItems(), this.sessionId(), 'ARROSTICINI').subscribe({
      next: (order) => {
