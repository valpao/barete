...
@Component({
  ...
  templateUrl: './bruschette.component.html',
  styleUrl: './bruschette.component.scss'
})
export class BruschetteComponent {
...
getCategories(): string[] {
  ...
  confirmOrder() {
    ...
    this.orders.confirm(this.cartItems(), this.sessionId(), 'BRUSCHETTE').subscribe({
      next: (order) => {
